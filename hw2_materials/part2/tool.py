...
def train(model, train_loader, val_loader, num_epoch, log_path, save_path, device, criterion, scheduler, optimizer, model_type):
    ...
    for i in range(num_epoch):
        ...
        with torch.no_grad():#speed up
            ...
            val_acc = corr_val_num / len(val_loader.dataset)
    ...
    plot_learning_curve(x, overall_acc, f'{model_type}_overall_train_acc')
    plot_learning_curve(x, overall_loss, f'{model_type}_overall_train_loss')
    plot_learning_curve(x, overall_val_acc, f'{model_type}_overall_val_acc')
    plot_learning_curve(x, overall_val_loss, f'{model_type}_overall_val_loss')
