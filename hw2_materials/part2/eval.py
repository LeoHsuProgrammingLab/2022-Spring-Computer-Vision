...
from myModels import myResnet, myLeNet, Resnet50, Resnext50
...
def main():
    ...
    parser.add_argument('--path', help='model_path', type=str, default='./save_dir/Resnext50/best_model.pt')
