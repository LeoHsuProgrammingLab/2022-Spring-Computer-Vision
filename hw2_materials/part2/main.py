...
from myModels import  myLeNet, myResnet, Resnet50, Resnext50, Resnet18
...
from cfg import Resnext50_cfg as cfg
...
def train_interface():
    ...
    model = Resnext50(num_out=num_out)
    ...
    # torch.save(model, f'{model_type}_size.pt')
    ### TO DO ### 
    ...
    train(model=model, train_loader=train_loader, val_loader=val_loader, 
          ...
          device=device, criterion=criterion, optimizer=optimizer, scheduler=scheduler, model_type=model_type)
